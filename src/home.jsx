...
export default function Home() {
  return (
    <div className="bg-white min-h-screen font-sans text-gray-800">
      ...
      {/* Footer */}
      <footer className="teximport React from "react";
...
t-center py-6 text-sm text-gimport React from "react";
...
export default function Home() {
  return (
    <div className="bg-white min-h-screen font-sans text-gray-800">
      ...
      {/* Footer */}
      <footer className="text-center py-6 text-sm text-gray-500">
        © 2025 LoadBalancer import React from "react";
