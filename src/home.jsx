      ...
      <section id="about" className="flex flex-col md:flex-row items-center px-10 py-16 bg-white">
        ...
        <div className="max-w-2xl">
          ...
          <p className="text-gray-700 leading-relaxed">
            In most organizations, burnout, bias, and silent resignations are treated like myths.
            They’re whispered on YouTube, buried under fancy dashboards — but never really acknowledged in systems.
            <br /><br />
